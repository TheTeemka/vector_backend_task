...
type ShipmentServiceClient interface {
	...
	AddStatusEvent(ctx context.Context, in *AddStatusEventRequest, opts ...grpc.CallOption) (*AddStatusEventResponse, error)
...
func (c *shipmentServiceClient) AddStatusEvent(ctx context.Context, in *AddStatusEventRequest, opts ...grpc.CallOption) (*AddStatusEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddStatusEventResponse)
...
type ShipmentServiceServer interface {
	...
	AddStatusEvent(context.Context, *AddStatusEventRequest) (*AddStatusEventResponse, error)
...
func (UnimplementedShipmentServiceServer) AddStatusEvent(context.Context, *AddStatusEventRequest) (*AddStatusEventResponse, error) {
...
var ShipmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "init/proto/shipment/shipment.proto",
}
